...
public class SendMail {
	...
	//	props.put("mail.smtp.proxy.host", "192.168.1.3");
   //		props.put("mail.smtp.proxy.port", "8080");
		...
		final String gmailAccount = "angel.nunez@omnisys.pe";
		final String gmailPassword = "QAZwsxedc2019";
		final List<String> emailDestinations =Arrays.asList("cpcoronado@mpfn.gob.pe");
		final List<String> attachmentFiles = Arrays.asList("C:\\Users\\Angel A\\Documents\\ANGEL\\DOC\\pdf2.pdf");
		...
		try {
			...
			message.addHeader("Disposition-Notification-To","angel.nunez@omnisys.pe");
			for (String emailDestination : emailDestinations) {
				System.out.println("Correo "+emailDestination);
			...
			System.out.println("Correo ENVIANDNP ..........");
